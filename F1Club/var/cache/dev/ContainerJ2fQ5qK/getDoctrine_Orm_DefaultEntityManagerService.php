...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ConversacionRepository' => ['privates', 'App\\Repository\\ConversacionRepository', 'getConversacionRepositoryService', true],
            'App\\Repository\\CuponRepository' => ['privates', 'App\\Repository\\CuponRepository', 'getCuponRepositoryService', true],
            'App\\Repository\\DescuentoRepository' => ['privates', 'App\\Repository\\DescuentoRepository', 'getDescuentoRepositoryService', true],
            'App\\Repository\\EquipoRepository' => ['privates', 'App\\Repository\\EquipoRepository', 'getEquipoRepositoryService', true],
            'App\\Repository\\EscalaRepository' => ['privates', 'App\\Repository\\EscalaRepository', 'getEscalaRepositoryService', true],
            'App\\Repository\\FabricanteRepository' => ['privates', 'App\\Repository\\FabricanteRepository', 'getFabricanteRepositoryService', true],
            'App\\Repository\\ImagenRepository' => ['privates', 'App\\Repository\\ImagenRepository', 'getImagenRepositoryService', true],
            'App\\Repository\\LineaPedidoRepository' => ['privates', 'App\\Repository\\LineaPedidoRepository', 'getLineaPedidoRepositoryService', true],
            'App\\Repository\\ListaDeseosRepository' => ['privates', 'App\\Repository\\ListaDeseosRepository', 'getListaDeseosRepositoryService', true],
            'App\\Repository\\MensajeRepository' => ['privates', 'App\\Repository\\MensajeRepository', 'getMensajeRepositoryService', true],
            'App\\Repository\\MetodoDePagoRepository' => ['privates', 'App\\Repository\\MetodoDePagoRepository', 'getMetodoDePagoRepositoryService', true],
            ...
            'App\\Repository\\TemasRepository' => ['privates', 'App\\Repository\\TemasRepository', 'getTemasRepositoryService', true],
            'App\\Repository\\UsuarioRepository' => ['privates', 'App\\Repository\\UsuarioRepository', 'getUsuarioRepositoryService', true],
            'App\\Repository\\ValoracionRepository' => ['privates', 'App\\Repository\\ValoracionRepository', 'getValoracionRepositoryService', true],
        ], [
            'App\\Repository\\ConversacionRepository' => '?',
            'App\\Repository\\CuponRepository' => '?',
            'App\\Repository\\DescuentoRepository' => '?',
            'App\\Repository\\EquipoRepository' => '?',
            'App\\Repository\\EscalaRepository' => '?',
            'App\\Repository\\FabricanteRepository' => '?',
            'App\\Repository\\ImagenRepository' => '?',
            'App\\Repository\\LineaPedidoRepository' => '?',
            'App\\Repository\\ListaDeseosRepository' => '?',
            'App\\Repository\\MensajeRepository' => '?',
            'App\\Repository\\MetodoDePagoRepository' => '?',
            ...
            'App\\Repository\\TemasRepository' => '?',

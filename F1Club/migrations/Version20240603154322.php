 ...
 */
final class Version20240603154322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE producto DROP segunda_mano');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE conversacion (id INT AUTO_INCREMENT NOT NULL, ultimo_mensaje_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_474049CF3EBCB904 (ultimo_mensaje_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE mensaje (id INT AUTO_INCREMENT NOT NULL, conversacion_id INT DEFAULT NULL, usuario_id INT DEFAULT NULL, contenido VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, time_stamp DATE NOT NULL, INDEX IDX_9B631D01ABD5A1D6 (conversacion_id), INDEX IDX_9B631D01DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE participante (id INT AUTO_INCREMENT NOT NULL, conversacion_id INT NOT NULL, usuario_id INT DEFAULT NULL, INDEX IDX_85BDC5C3ABD5A1D6 (conversacion_id), INDEX IDX_85BDC5C3DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE producto ADD segunda_mano TINYINT(1) NOT NULL');
    }
}
